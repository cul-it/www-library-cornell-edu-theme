  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <div class="row">
          ...
          <?php
              ...
              elseif ($location_hours == 'Engineering') {
               ...
               elseif ($location_hours == 'Hotel') {
                $full_hours = 'The Hotel Library will be closed from June 6, 2014 to August 17, 2014. Librarians are available for research help at <a href="mailto:hotelllibrary.cornell.edu">hotellibrary@cornell.edu</a>.';
              }
              else {
      ...
      <div class="col-sm-4">
        ...
        <p><a href="https://www.cornell.edu/about/maps/index.cfm?overlays=Library">View map of Cornell libraries</a></p>
      </div>
    </div>
