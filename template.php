...
function bootstrap_cul7_menu_link(array $variables)
{
    ...
    if ($element['#below']) {
        ...
        if (('management' == $element['#original_link']['menu_name']) && (module_exists('navbar'))) {
    ...
    if (($element['#href'] == $_GET['q'] || ('<front>' == $element['#href'] && drupal_is_front_page())) && (empty($element['#localized_options']['language']))) {
